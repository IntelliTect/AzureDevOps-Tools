    ...
    if ($PSCmdlet.ShouldProcess(
        ...
        foreach ($endpoint in $sourceEndpoints) {
            ...
            try {
                ...
                Start-ADOServiceConnectionRolesMigration -SourceProjectId $sourceProject.id -TargetProjectId $targetProject.id -EndpointId $endpoint.id
            }
            catch {
...
function Start-ADOServiceConnectionRolesMigration([string] $SourceProjectId, [string] $TargetProjectId, [string] $EndpointId) {
    $sourceRoleAssignments = Get-RoleAssignments -OrgName $SourceOrgName -ProjectId $SourceProjectId -EndpointId $EndpointId -Headers $SourceHeaders
