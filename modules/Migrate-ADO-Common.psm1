...
# Dashboards
function Get-Dashboards([string]$projectName, [string]$orgName, [string]$team, $headers) {
...
function Get-Dashboard([string]$projectName, [string]$orgName, [string]$team, $headers) {
...
function New-Dashboard([string]$projectName, [string]$orgName, [string]$team, $headers, $dashboard) {
